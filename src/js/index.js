...
const wave4 = document.querySelector('#wave-four')
const wave5 = document.querySelector('#wave-five')
const wave6 = document.querySelector('#wave-six')

if (window.screen.availWidth > 768) {
    if (wave1) {
        let myWave = $('#wave-one').wavify({
...
} else if (window.screen.availWidth <= 768 && window.screen.availWidth > 580) {
    if (wave1) {
        let myWave = $('#wave-one').wavify({
            container: '.bg-animation',
            height: 1,
...
} else if (window.screen.availWidth <= 580) {
    if (wave1) {
        let myWave = $('#wave-one').wavify({
            container: '.bg-animation',
            height: 1,
...
const inputsForCopy = document.querySelectorAll('.input--copy')
const btnForCopy = document.querySelectorAll('.btn--copy')

if (inputsForCopy) {
    inputsForCopy.forEach(e => {
...
if (btnForCopy) {
    btnForCopy.forEach(e => {
        e.addEventListener('click', () => {
            e.previousSibling.previousSibling.select()
            document.execCommand("copy")
        })
    })
}
